...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        const externalApiUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/admin-panel/events/`;
        ...
        const totalDuration = Date.now() - startTime;
        console.error(`[${requestId}] 💥 Events fetch error after ${totalDuration}ms:`, error);
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const totalDuration = Date.now() - startTime;
        console.error(`[${requestId}] 💥 Event creation error after ${totalDuration}ms:`, error);
